...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='holds participants specific to a tournament';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `participant` VALUES (40,'asd','1',NULL,NULL,34),(41,'qwe','2',NULL,NULL,34),(42,'sdf','3',NULL,NULL,34);
/*!40000 ALTER TABLE `participant` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `participant2match`
--

DROP TABLE IF EXISTS `participant2match`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `participant2match` (
...
--
-- Dumping data for table `participant2match`
--

LOCK TABLES `participant2match` WRITE;
/*!40000 ALTER TABLE `participant2match` DISABLE KEYS */;
/*!40000 ALTER TABLE `participant2match` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tournament` (
  ...
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `code_UNIQUE` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Holds the individual tournaments';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tournament` VALUES (-1,'test','testDbName','SWISS'),(34,'3','','SWISS');
...
-- Dump completed on 2020-02-28 15:52:01
