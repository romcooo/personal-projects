...
public class FastCollinearPoints {
    ...
    /**
     * First, sort the array by y/x. This is important so that when iterating through the points later, the latter points will be
     *  further away and so the last point on a line is always the farthest one.
     ...
     * it starts looking for a new line. The last line is stored as a LineSegment.
     *
     */
